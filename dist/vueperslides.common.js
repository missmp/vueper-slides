...
/* harmony default export */ var vueperslidesvue_type_script_lang_js_ = ({
  ...
  methods: {
    ...
    goToSlideManual: function goToSlideManual() {
      ...
      if (nextSlideIsClone !== null) {
        ...
        setTimeout(function () {
          ...
          if (!tooLateToSetTimeout) {
            ...
            _this5.goToSlide(nextSlideIsClone ? 0 : _this5.slides.count - 1, {
              animation: false,
              jumping: true
            });
    ...
    removeSlide: function removeSlide(uid) {
      ...
      this.slides.list.some(function (slide, i) {
        if (slide._uid === uid) {
          ...
          _this7.slides.count = _this7.slides.list.length; // If the slide to remove is the current slide, slide to the previous slide.

          if (uid === _this7.slides.activeUid) {
            _this7.slides.activeUid = null;

            _this7.goToSlide(i - 1, {
              autoPlaying: true
            });
          }
